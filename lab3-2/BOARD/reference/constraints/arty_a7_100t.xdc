...
set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { BTN_START }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
...
set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { BTN_RESET }]; #IO_L16P_T2_35 Sch=ck_rst
